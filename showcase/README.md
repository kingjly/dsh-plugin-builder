...
These three independent packages were produced by following the repository's `SKILL.md` workflow against `@deepseek-ai/dsh@0.1.0-rc.6`.
...
Each package contains its own installable `dsh.bundle`, design record, development overlay, smoke tests, and README. The two Web plugins additionally ship browser bundles declared by `dsh.client`.
